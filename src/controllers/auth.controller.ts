...
import { AuthenticatedRequest, AuthResponse, LoginRequest, RegisterRequest } from '../types';
...
export class AuthController {
  ...
  static async login(req: Request, res: Response): Promise<void> {
    try {
      ...
      const user = await AuthController.getUserService().authenticateUser(credentials);
  ...
  static async getProfile(req: Request, res: Response): Promise<void> {
    try {
      ...
      const user = await AuthController.getUserService().getUserById(authenticatedReq.user.userId);
